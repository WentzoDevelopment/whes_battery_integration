...
SENSOR_MAP = {
    ...
    "ac_history_positive_power_in_kwh": ("Return to Grid Energy (hist)", UnitOfEnergy.KILO_WATT_HOUR, SensorDeviceClass.ENERGY, SensorStateClass.TOTAL_INCREASING),
    "ac_history_negative_power_in_kwh": ("Grid Import Energy (hist)", UnitOfEnergy.KILO_WATT_HOUR, SensorDeviceClass.ENERGY, SensorStateClass.TOTAL_INCREASING),
}
