...
SENSOR_MAP = {
    ...
    "ems_dc_power_neg": ("Battery Charge (DC -)", UnitOfPower.WATT, SensorDeviceClass.POWER, SensorStateClass.MEASUREMENT),
    "ems_dc_power_pos": ("Battery Discharge (DC +)", UnitOfPower.WATT, SensorDeviceClass.POWER, SensorStateClass.MEASUREMENT),
    "ems_ac_active_power": ("EMS AC Active Power", UnitOfPower.WATT, SensorDeviceClass.POWER, SensorStateClass.MEASUREMENT),
    ...
    "ems_ac_active_power_A": ("EMS Phase A Power", UnitOfPower.WATT, SensorDeviceClass.POWER, SensorStateClass.MEASUREMENT),
    "ems_ac_active_power_B": ("EMS Phase B Power", UnitOfPower.WATT, SensorDeviceClass.POWER, SensorStateClass.MEASUREMENT),
    "ems_ac_active_power_C": ("EMS Phase C Power", UnitOfPower.WATT, SensorDeviceClass.POWER, SensorStateClass.MEASUREMENT),
